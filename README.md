# WARNING: 허가 없는 네트워크 스캔 금지

**`wifi-scanner`는 본인 소유이거나 네트워크 소유자/관리자로부터 명시적으로 허가받은 환경에서만 사용할 수 있습니다.**

허가 없이 타인의 네트워크, 학교/회사/공공기관/숙박시설/카페 등 제3자가 운영하는 네트워크, 또는 공개 인터넷 대역을 스캔하는 행위는 불법이거나 약관/보안 정책 위반일 수 있습니다. 불법적인 목적, 무단 침입 준비, 서비스 방해, 정보 수집, 취약점 악용, 인증 우회, 계정 탈취, 비밀번호 대입, 은닉 또는 회피 목적으로 사용할 수 없습니다.

이 도구를 실행하기 전에 반드시 스캔 대상과 범위에 대한 권한을 확인하세요. 사용으로 인해 발생하는 모든 책임은 사용자 본인에게 있습니다.
...
`wifi-scanner`는 합법적인 내부망 자산 발견과 운영 점검을 돕기 위한 도구입니다. 본인 소유의 네트워크, 직접 관리 책임이 있는 네트워크, 또는 네트워크 소유자/관리자로부터 명시적인 허가를 받은 환경에서만 사용해야 합니다.

허가 없이 타인의 네트워크, 학교/회사/공공기관/숙박시설/카페 등 제3자가 운영하는 네트워크, 또는 공개 인터넷 대역을 스캔하는 행위는 관련 법률, 약관, 내부 보안 정책을 위반할 수 있으며 민형사상 책임이 발생할 수 있습니다. 불법적인 목적, 무단 침입 준비, 서비스 방해, 정보 수집, 취약점 악용, 인증 우회, 계정 탈취, 비밀번호 대입, 은닉 또는 회피 목적으로 사용할 수 없습니다.

이 도구를 실행하는 사용자는 스캔 대상과 범위에 대한 권한을 사전에 확인해야 하며, 사용으로 인해 발생하는 모든 책임은 사용자 본인에게 있습니다.
